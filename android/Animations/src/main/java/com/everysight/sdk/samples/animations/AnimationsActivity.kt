...
class AnimationsActivity : Activity(), IEvsCommunicationEvents, IEvsAppEvents {

    private val screen = AnimationsScreen()
    private lateinit var txtStatus: TextView
    companion object{
        private const val TAG = "AnimationsActivity"
    }
    ...
    private fun initSdk() {
        ...
        with(Evs.instance().comm()){
            registerCommunicationEvents(this@AnimationsActivity)
