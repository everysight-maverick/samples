...
class UIElementsActivity : Activity(), IEvsCommunicationEvents, IEvsAppEvents {

    private val screen = UIElementsScreen()
    private lateinit var txtStatus: TextView
    companion object{
        private const val TAG = "UIElementsActivity"
    }
    ...
    private fun initSdk() {
        ...
        with(Evs.instance().comm()){
            registerCommunicationEvents(this@UIElementsActivity)
