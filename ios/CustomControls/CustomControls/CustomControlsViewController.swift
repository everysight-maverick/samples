...
class CustomControlsViewController: UIViewController {
    ...
    private let screen = CustomControlsScreen()
...
extension CustomControlsViewController : IEvsCommunicationEvents {
...
extension CustomControlsViewController : IEvsAppEvents {
