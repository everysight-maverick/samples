...
class ArViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Evs.instance().screens().addScreen(screen: arDemoScreen)
    }
    ...
    @IBAction func calibrate(_ sender: Any) {
        Evs.instance().showUI(name: "calibrate")
    }
...
extension ArViewController : IEvsCommunicationEvents {
...
extension ArViewController : IEvsAppEvents {
